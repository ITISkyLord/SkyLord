    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        ApprenticeLevel_ApprenticeLevelId = c.Int(),
                        Mage_MageId = c.Long(),
                    })
                .PrimaryKey(t => t.ApprenticeId)
                .ForeignKey("dbo.ApprenticeLevels", t => t.ApprenticeLevel_ApprenticeLevelId)
                .ForeignKey("dbo.Mages", t => t.Mage_MageId)
                .Index(t => t.ApprenticeLevel_ApprenticeLevelId)
                .Index(t => t.Mage_MageId);
            
            CreateTable(
                "dbo.ApprenticeLevels",
                c => new
                    {
                        ApprenticeLevelId = c.Int(nullable: false, identity: true),
                    })
                .PrimaryKey(t => t.ApprenticeLevelId);
                ...
                c => new
                    {
                        ...
                        Name = c.String(),
                        BuildingLevel = c.Int(nullable: false),
                        Island_IslandId = c.Int(),
                    })
                ...
                c => new
                    {
                        ...
                        Name = c.String(),
                        TechnologyLevel = c.Int(nullable: false),
            ...
            CreateTable(
                ...
                c => new
                    {
                        WorldId = c.Long(nullable: false),
                    })
                .PrimaryKey(t => t.WorldId)
                .ForeignKey("dbo.Worlds", t => t.WorldId)
                .Index(t => t.WorldId);
                ...
                c => new
                    {
                        ...
                        Name = c.String(),
                        MageLevel = c.Int(nullable: false),
                        Island_IslandId = c.Int(),
                    })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Maps", "WorldId", "dbo.Worlds");
            DropForeignKey("dbo.Islands", "Map_WorldId", "dbo.Maps");
            DropForeignKey("dbo.Technologies", "Player_PlayerId", "dbo.Players");
            DropForeignKey("dbo.Profiles", "PlayerId", "dbo.Players");
            ...
            DropForeignKey("dbo.Apprentices", "ApprenticeLevel_ApprenticeLevelId", "dbo.ApprenticeLevels");
            ...
            DropIndex("dbo.Maps", new[] { "WorldId" });
            DropIndex("dbo.Technologies", new[] { "Player_PlayerId" });
            DropIndex("dbo.Profiles", new[] { "PlayerId" });
            ...
            DropIndex("dbo.Islands", new[] { "Map_WorldId" });
            ...
            DropIndex("dbo.Apprentices", new[] { "ApprenticeLevel_ApprenticeLevelId" });
            ...
            DropTable("dbo.ApprenticeLevels");
