...
namespace ITI.SkyLord.Controllers
{
    public class RessourceController : Controller
    {
        ...
        public IActionResult SeeRessources(int islandId)
        {
            ...
            SetupContext.FillStandardVM( sr, SetupContext.GetPlayer( ClaimTypes.NameIdentifier ).PlayerId, islandId );
        ...
        {
            SeeRessourcesViewModel sr = new SeeRessourcesViewModel();
            Player player = SetupContext.GetPlayer(ClaimTypes.NameIdentifier);
            SetupContext.FillStandardVM( sr, SetupContext.GetPlayer( ClaimTypes.NameIdentifier ).PlayerId, islandId );
        ...
        public IActionResult AddRessources( string name, string quantity, int islandId)
        {
            ...
            Player owner = SetupContext.GetPlayer(ClaimTypes.NameIdentifier);
            SeeRessourcesViewModel sr = new SeeRessourcesViewModel();
