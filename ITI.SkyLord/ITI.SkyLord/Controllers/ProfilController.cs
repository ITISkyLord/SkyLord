...
namespace ITI.SkyLord.Controllers
{
    public class ProfilController : Controller
    {
        ...
        public IActionResult Index( long islandId )
        {
            ...
            Player p = SetupContext.GetPlayer( ClaimTypes.NameIdentifier );
            ...
            SetupContext.FillStandardVM( profilViewModel, SetupContext.GetPlayer( ClaimTypes.NameIdentifier ).PlayerId, islandId );
        ...
        public IActionResult ProfilOfOtherPlayer( ProfilViewModel model, long islandId, long otherPlayerId )
        {
            ...
            //Récupérer la description dans la BDD
            Player currentPlayer = SetupContext.GetPlayer( ClaimTypes.NameIdentifier );
