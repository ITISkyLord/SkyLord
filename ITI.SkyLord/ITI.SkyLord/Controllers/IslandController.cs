...
namespace ITI.SkyLord.Controllers
{
    public class IslandController : GenericController
    {
        public IActionResult OverView(long islandId)
        {
            ...
            SetupContext.FillStandardVM(ovvm, SetupContext.GetPlayer(ClaimTypes.NameIdentifier).PlayerId, islandId);
            return View(ovvm);
        }
        ...
        public IActionResult SeeMyIsland(long islandId = 0)
        {
            ...
            SeeMyIslandViewModel islandViewModel = CreateBuildingViewModel(currentIsland.IslandId, SetupContext.GetPlayer(ClaimTypes.NameIdentifier).PlayerId);
