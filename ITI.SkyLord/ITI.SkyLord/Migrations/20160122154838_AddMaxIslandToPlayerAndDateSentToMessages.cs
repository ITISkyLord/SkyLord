...
{
    public partial class AddMaxIslandToPlayerAndDateSentToMessages : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropForeignKey(name: "FK_IdentityUserRole<string>_IdentityRole_RoleId", table: "AspNetUserRoles");
            migrationBuilder.DropForeignKey(name: "FK_IdentityUserRole<string>_IdentityUser_UserId", table: "AspNetUserRoles");
            migrationBuilder.DropColumn(name: "MaxIsland", table: "Player");
            migrationBuilder.DropColumn(name: "DateSent", table: "Message");
            migrationBuilder.AddForeignKey(
