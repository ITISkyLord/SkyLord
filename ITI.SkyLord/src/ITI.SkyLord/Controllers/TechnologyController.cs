...
//            // Get all the exisiting technologies and all the player's technologies to compare them further
//            List<TechnologyLevel> availableTechnologies = technologyManager.GetExistingTechnologies();
...
//                    isResearched = true;
//                    isAvailable = true;
//                    // Add the technoogyLevel with it's bonuses resolve
