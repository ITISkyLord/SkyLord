...
namespace ITI.SkyLord
{
    public class LevelSeed
    {
        ...
        {
            Requirement towerLevel2Requirement = null;
            Requirement towerLevel3Requirement = null;
            Requirement towerLevel4Requirement = null;
            Requirement towerLevel5Requirement = null;
            Requirement towerLevel6Requirement = null;
            Requirement towerLevel7Requirement = null;
            Requirement towerLevel8Requirement = null;
            Requirement towerLevel9Requirement = null;
            Requirement towerLevel10Requirement = null;
            ...
            using ( SetupContext context = new SetupContext() )
            {
                ...
                //towerLevel2Requirement = AddBuildingRequirement( context, BuildingName.tower, 1 );
                //towerLevel3Requirement = AddBuildingRequirement( context, BuildingName.tower, 2 );
                //towerLevel4Requirement = AddBuildingRequirement( context, BuildingName.tower, 3 );
                //towerLevel5Requirement = AddBuildingRequirement( context, BuildingName.tower, 4 );
                //towerLevel6Requirement = AddBuildingRequirement( context, BuildingName.tower, 5 );
                //towerLevel7Requirement = AddBuildingRequirement( context, BuildingName.tower, 6 );
                //towerLevel8Requirement = AddBuildingRequirement( context, BuildingName.tower, 7 );
                //towerLevel9Requirement = AddBuildingRequirement( context, BuildingName.tower, 8 );
                //towerLevel10Requirement = AddBuildingRequirement( context, BuildingName.tower, 9 );
